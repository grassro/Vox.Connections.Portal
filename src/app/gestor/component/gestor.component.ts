...
export class GestorComponent implements OnInit {
  ...
  submit(): boolean {
    ...
    // data.formacao = this.step2.controls['formacao'].value;
    ...
    data.linkedin = this.step5.controls['linkedin'].value;
    data.idUsuario = this.guid;

    if (this.editing) {
      data.curriculo = this.model.curriculo;
      data.idGestor = this.model.idGestor;
